...
public class C02_ReadExcel {
    ...
    public void test01() throws IOException {
        ...
        // - Sayfa2'deki Fiziki olarak kullanilan satir sayisini bulun
        System.out.println("Sayfa2 satir sayisi : " + workbook.getSheet("Sayfa2").getLastRowNum()+1);
        System.out.println("Sayfa2 fiziki olarak kullanilan satir sayisi : " +
        ...
        for (int i = 0; i <= sonSatirIndexi; i++) { // basligi almamak icin 1'den baslattim
